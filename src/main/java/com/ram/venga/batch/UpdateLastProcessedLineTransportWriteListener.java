...
public class UpdateLastProcessedLineTransportWriteListener implements ItemWriteListener<Object> {

	private JobInfoRepository jobInfoRepository;

	private JobInfo jobInfo;

	public UpdateLastProcessedLineTransportWriteListener(JobInfo jobInfo, JobInfoRepository jobInfoRepository) {
